            ...
            <div class="card-body">
                ...
                <form>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" readonly class="form-control" id="title" value="{{ $product->title }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" readonly class="form-control" id="category_id"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" readonly class="form-control" id="price" value="{{ $product->price }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" readonly class="form-control" id="old_price"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input disabled type="checkbox" class="form-control" id="is_new"
                                   @if( $product->is_new == 1 )
                                   value="1"
                                   checked
                                @endif>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input disabled type="checkbox" class="form-control" id="is_hit"
                                   @if( $product->is_hit == 1 )
                                   value="1"
                                   checked
                                @endif>
                        ...
                        @if($product->img !== 'no-image.png')
                            <div class="showImg">
                                <img src="{{ asset('assets/far/img/product/' . $product->img) }}" alt=""
                                     id="oldImg">
                                @else
                                    <img src="{{ asset('assets/far/img/product/no-image.png')}}" alt=""
                                         id="oldImg">
                            </div>
                        @endif
                    </div>
