            ...
            <div class="row" style="background-color: rgba(230,230,230, .7); border-radius: 5%; padding-top: 30px;">
                    ...
                    <div class="col-xl-6 col-md-6 col-lg-6" style="opacity: 100%">
                        <div class="single_delicious d-flex align-items-center">
                            <div class="thumb">
                                <img src="{{ asset('assets/far/img/product/' . $product->img) }}" alt=""  style="max-width: 400px">
                                @if($product->is_new)
                            ...
                            <div class="info">
                                ...
                                @if ($product->old_price)
                                    <span style="display: inline; text-decoration: line-through; font-size: 20px; margin-right: 10px;">{{$product->old_price}} руб</span>
                                @endif
